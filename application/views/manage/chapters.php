 ...
 <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo base_url().'administ/editions/'?>">Editions</a></li>
        <li><a href="<?php echo base_url().'administ/books/'.$book;?>">Books</a></li>
      ...
      <div class="col-md-9">
       <div class="box" style="<?php echo 'height:'.$height.'px;';?>;border-radius: 15px;box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
            ...
            <div class="box-header with-border">
              ...
              <div class="col-md-3">
                <button type="button" class="btn bt-addstudent" style="background: rgb(69,56,217);background: linear-gradient(305deg, rgba(69,56,217,0.9248074229691877) 0%, rgba(95,208,157,1) 100%);color: #fff;" data-toggle="modal" data-target="#add_medium_modal"><i class="fa fa-plus-o"></i> ADD NEW CHAPTER
                </button>
              </div>
            <!-- form start -->
            </div>
...
<div class="col-md-6">
  <h4 class="modal-title">Add New Chapter</h4></div>
</div>
...
<script type="text/javascript">
  ...
  function edit_classes(id){
    ...
    $.ajax({
        url:base_url+"get_chapters_details",
        method:"POST",
        data:{id:id},
        success:function(response){
